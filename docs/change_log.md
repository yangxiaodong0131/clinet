...
* 增加删除、保存成功或失败提示
* 修改病案历史不显示及折叠报错问题
* 修改RightPanelLocal默认查询模板为文档
* 修改RightPanel显示内容的关闭事件判断错误
* 修改上传按钮显示判断
* 修改远程下载及参考事件点击方法
### 2018-09-26
* stat/library修改状态的单元格增加颜色区分
* stat本地修改
* 修改stat行点击为第一个单元格
* 修复stat本地文件读取错误
* 修改默认服务器设置
...
* 显示病案文档内容
* 删除edit返回按钮
* 实现edit的Library的本地及远程查询
* 修复edit部分远程读取stat文件错误
### 2018-08-21
* stat查询排除bug
* 修改用户设置
* library增加新建功能
...
* 修改远程cda不能打开问题
* 返回病案采集禁止默认查询cda文件
* 增加Edit本地数据分析的查询及展示功能
* 修改区块链
* 添加原jklf项目的数据样例
### 2018-08-20
* Edit的RightBar中下拉菜单联动显示
* 完成library页面修改功能
* 右侧默认显示为本地-文件
* 左侧table改为右侧显示
* 修改编辑病案判断条件
...
* 添加操作记录
### 2018-08-18
* 调整edit、stat、library的工具栏
### 2018-08-17
* 增加用户设置判断/完善区块链服务显示
* 修改library新建不为空及输入内容跳行问题
* 修复bug
* home页的《待办事项》调整为《操作日志》
* 增加用户名判断
* 添加首页信息显示
* library禁止编辑Header表头及ID列
* 修改library录入格式
* 修改Home页样式
* 修改创建模板显示为空问题
* 修改版本号1.0.0，home也添加数据表统计
### 2018-08-16
* 增加socket离线判断
* 修改术语字典无数据提示，无数据时下载功能消失
* 修改library远程缓存
* 增加library的新建功能
* 修改library的本地保存
* 修改librazry的远程保存
...
* section+key调用右侧提示
* header不高亮显示
* 增加术语字典无数据显示，修改页码bug，优化library本地远程文件判断
* 修改专家提示查询及显示
* 修改参考、历史等方法调用判断
* 修改专家提示点击方法
### 2018-08-09
...
* 修改提示内容选择键值
* 增加显示提示调用
* 修改字典库本地文件和远程文件维度选择bug
* 增加cdh读取变Object
* 解决删除删除未保存病案同时删掉2018病案问题
* 修改删除未保存病案问题
* 修改输入框调用病案参考、病案历史判断
### 2018-07-06
* 增加引导页内容
...
* 显示摘要的创建时间
* 修改新建、删除、编辑事件
* 添加 输入框提示列表中 key值得点击事件
* 修改 edit 远程文件 测试代码 以及 部分流程
* 空内容退出时不保存 
* 启动项目自动打开未保存内容
* 修改cda上传
* 病案参考
### 2018-06-28
* 解决 library维度查询 左侧无维度显示问题
* 增加未保存文件数提示
* 窗口关闭时保存“未保存文件”
* 修复 library 进入 edit中 隐藏 参考按钮问题
### 2018-06-27
* 增加窗口关闭事件并实现全部保存功能
* 修改远程病案历史查询不到问题
* 增加病案历史内容显示
...
* 增加未保存状态显示
### 2018-06-26
* 修改 参考病案 不同section 样式
* 修复 edit 点击单行 参考按钮后 页面报错问题
* 修改右侧下拉框不变问题
* 增加病案参考调用方法
* 修改历史病案
* 修改不显示内容问题
* 增加关闭窗口判断
* 修改 run test 时library报错问题 合并代码缺失
### 2018-06-25
* 修改 library中 本地远程 关于维度选择的测试代码
* 增加editdoc的测试代码
* 修复警告
* 修复标题错误
* 修改 library 维度下拉 动态按钮
* 修改 关于 维度下拉的 测试代码
### 2018-06-22
