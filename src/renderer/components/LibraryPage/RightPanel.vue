  ...
  export default {
    ...
    methods: {
      ...
      serverPage: function (data) {
        ...
        dataDB(this, this.$store.state.Library.tableType, 'library', { fileType: this.$store.state.Library.libraryTableInfo.tableName }, 'libraryFile', { sort: this.$store.state.Library.serverSort, dimensionType: null, dimensionServer: this.$store.state.Library.serverDimension }, skip, 30)
      },
      onClickSort: function (field, type) {
        this.$store.commit('LIBRARY_SET_SERVER_SORT', [field, type])
        dataDB(this, this.$store.state.Library.tableType, 'library', { fileType: this.$store.state.Library.libraryTableInfo.tableName }, 'libraryFile', { sort: this.$store.state.Library.serverSort, dimensionType: null, dimensionServer: this.$store.state.Library.serverDimension }, 0, 30)
      },
