        ...
        if (!this.$store.state.System.user.login) {
          ...
          switch (value) {
            case '机构信息':
              ...
              break;
            case '科室信息':
              console.log(this.$store.state.System.pageInfo.department);
              this.$store.commit('SYSTEM_GET_ORGPAGE', 'getDepartment');
              sGetDepart(this, [this.$store.state.System.server, this.$store.state.System.port], this.$store.state.System.user, 1);
